...
import { useAuthStore, DEMO_LOGIN_ACCOUNTS } from "@/store/auth-store";
...
import { Mail, Lock, Eye, EyeOff, ArrowLeft, User, Shield, GraduationCap } from "lucide-react";
    ...
    <div className="container mx-auto flex min-h-[calc(100vh-8rem)] items-center justify-center px-4 py-8">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>مرحباً بعودتك إلى بكالوريا بيه</CardDescription>
        </CardHeader>
        ...
        <CardContent>
          ...
          <Button variant="outline" className="w-full" onClick={() => toast.info("تسجيل الدخول بـ Google غير متاح في النسخة التجريبية")}>
          ...
          <div className="mt-6 rounded-lg border border-dashed bg-muted/30 p-3">
            ...
            <div className="grid grid-cols-3 gap-2">
              ...
              >
                ...
                <span className="text-[10px]">طالب</span>
              </Button>
              <Button
                size="sm"
                variant="outline"
              ...
              >
                ...
                <span className="text-[10px]">مدرس</span>
              </Button>
              <Button
                size="sm"
                variant="outline"
              ...
              >
                ...
                <span className="text-[10px]">مدير</span>
              </Button>
            </div>
          </div>
        </CardContent>
